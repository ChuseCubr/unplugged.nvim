...
---@param get_goto_chunk fun(get_next_chunk: GitChunk[], line: integer): GitChunk Function that defines the chunk to jump to
...
function M.goto_prev()
	goto(function(buf_chunks, line)
		local prev_chunk = vim.iter(buf_chunks):find(
			---@param chunk GitChunk
			function(chunk)
				return chunk.line < line
			end
